  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span
            className={`text-[2rem] sm:text-[2.625rem] text-[#361968] font-bold flex flex-col items-center justify-center`}
          >
            <h2>At ~3.5 Crore</h2>
          ...
          <div
            className={`w-full h-[600px] sm:h-full px-32 py-4 -translate-x-[1000px] sm:-translate-x-[1500px] ${
